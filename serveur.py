...
def addPlayer():
    ...
    if 'name' in data:
        table =     table = "{\"name\": \"nom\",\"location\":[{\"latitude\": 25.0}, {\"longitude\":50.0}],\"info\":[{\"cash\":1.0},{\"sales\": 0.0},{\"profit\": 0.0},{\"drinksOffered\": [{\"name\":\"vodka\"},{\"price\":14.99},{\"hasAlcohol\":1},{\"isCold\":1}]}]}"
